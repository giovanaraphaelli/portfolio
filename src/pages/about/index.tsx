    ...
    <Layout subtitle="<!-- sobre mim -->" id="about">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-8 max-w-6xl">
        <div className="flex items-center flex-col gap-6">
          <img
            className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-60 lg:h-60 object-cover object-top rounded-full border-2 shadow-md border-light-surface dark:border-dark-accent"
            src="eu.png"
            alt="Profile"
          />
          <div ref={ref}>
