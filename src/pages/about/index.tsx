      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-stretch">
          ...
          <div className="flex flex-col gap-6 h-full">
            ...
            <div className="flex flex-col font-mono text-sm border-t border-light-secondary/25 dark:border-dark-secondary/20 mt-auto">
              {[
          ...
          <div className="relative">
            ...
            <img
              ...
              className="w-full h-[520px] md:h-[600px] object-cover object-left-bottom rounded-2xl"
            />
